...
import { fadeInUp, fadeInRight, staggerContainer, viewportOnce } from '@/lib/animations';

interface ContactTeaserClientProps {
    data: {
        headline?: string;
        text?: string;
    };
    openingHours: readonly { readonly days: string; readonly times: string }[];
}

export function ContactTeaserClient({ data, openingHours }: ContactTeaserClientProps) {
    return (
